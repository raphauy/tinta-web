  ...
  landing: {
    ...
    development: {
      ...
      services: {
        tintaLink: {
          title: "Tinta Link",
          description: "Tinta Link es una aplicación web que permite a los usuarios compartir enlaces de forma rápida y sencilla."  
        },
        tintaPlanner: {
          title: "Tinta Planner",
          description: "Tinta Planner es un Planner de Contenido de la agencia pensando en ahorrar tiempo y reducir la fricción en la comunicación con nuestros clientes."
        }
      }
    },
    academy: {
