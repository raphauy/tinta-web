  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[310px] max-w-full relative flex-shrink-0 border shadow-md border-border rounded-2xl px-8 py-6 md:w-[310px] bg-slate-50 dark:bg-black dark:border-white dark:shadow-white dark:text-white"
            key={item.name}
          >
            <blockquote>
              <div
